...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Edit Issue: {{$issue->issue}}</div>
             
    <form action="{{url('issue/edit')}}/{{$issue->id}}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
  ...
  <input type="text" class="form-control" id="issue" name="issue" value="{{$issue->issue}}">
</div>
                                                   <div class="form-group">
    ...
    $("#file").fileinput({showCaption: false, showUpload: false});
                     ...
                     <div class="form-group">
                        <label>Description:</label> 
                         <textarea id="des" name="des" >{!!$issue->des!!}</textarea>
                    </div>
                    
                     <div class="form-group">
                         <label>Tags (For SEO):</label></br>
  <input type="text" class="form-control" id="tags" name="tags" data-role="tagsinput" value="{{$issue->tags}}">
